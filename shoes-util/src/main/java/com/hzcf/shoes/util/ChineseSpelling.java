 ...
 * 
 *
 * Description: 汉字拼音工具类，输入一个汉字，可以得到它的拼音。
 *
 * @author yaodawei
 * @version 1.0
 * <pre>
...
public class ChineseSpelling {
	...
	/**
	 * 
	 * Description: 输入多个汉字，返回它的拼音
	 *
	 * @param 
	 * @return String
	 * @throws 
	 * @Author yaodawei
	 * Create Date: 2013-7-17 下午02:43:11
	 */
	public static String convertEnglishStr(String str){
		String retStr = "";
		for (int i = 0; i < str.length(); i++) {
			retStr += convert(str.substring(i, i+1));
		}
		return retStr;
	}
}
