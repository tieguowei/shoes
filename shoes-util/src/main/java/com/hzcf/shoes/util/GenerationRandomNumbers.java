 ...
 * 一个获得随机数的类
 * <p>
 * Copyright: 2004 dyp add
 * </p>
 * 
 * @version 1.1
 */

public class GenerationRandomNumbers {
	 ...
	 * @throws Exception
	 */
	public static String getRandomNum(String size) throws Exception{
		GenerationRandomNumbers.setCharset("0-9");//指定字符内容为"0"-"z"，当然也可以是别的，比如"a-z"或"A-Z" 
		GenerationRandomNumbers.setLength(size);//指定字符长度 
		GenerationRandomNumbers.generateRandomObject();//生成随机数 
		return GenerationRandomNumbers.getRandom();//得到随机数
	}
	
	public static void main(String[] args) throws Exception {
		GenerationRandomNumbers.setCharset("0-z");//指定字符内容为"0"-"z"，当然也可以是别的，比如"a-z"或"A-Z" 
		GenerationRandomNumbers.setLength("20");//指定字符长度 
		GenerationRandomNumbers.generateRandomObject();//生成随机数 
		String str = GenerationRandomNumbers.getRandom();//得到随机数 
		System.out.println(str);//输出结果：PE68P<HD]tnmj0Fp8i0R 
	}
}