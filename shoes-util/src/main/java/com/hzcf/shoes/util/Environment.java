...
public class Environment {
	...
	private static final String[] CONFIG_LOCATIONS = new String[]{"classpath:spring/spring-base.xml","classpath:spring/spring-redis.xml","classpath:spring/spring-hessian.xml"};
