...
import com.hzcf.shoes.dao.SystemDictMapper;
import com.hzcf.shoes.model.SystemDict;
import com.hzcf.shoes.util.Environment;
...
public class SystemDataUtil implements Servlet {
	private static final Logger logger = LogDefault.getLogger(SystemDataUtil.class);
