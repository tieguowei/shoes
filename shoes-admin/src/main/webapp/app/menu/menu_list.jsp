					...
					<table class="tableForm" border="0" width="80%">
						...
						<tr>
							...
							<td class="FormF">
 								...
 								<input id="nameZh" name="nameZh" class="easyui-textbox" data-options="required:true" style="width: 280px;height: 24px;" />
 						</td>
						</tr>
						<tr>
							<td class="tdR">
							...
							<td class="FormF">
								...
								<input id="nameEn" name="nameEn" class="easyui-textbox" data-options="required:true" style="width: 280px;height: 24px;" />
							</td>
						</tr>
						<tr>
							<td class="tdR">
