			...
			<td width="15%" class="tdR"><span style="color: red">*</span>鞋厂名称:</td>
                ...
                <td>
                    <input id="time" name="time"   maxlength="30"
                     class='easyui-datebox' style="width: 150px;height: 24px;" data-options="prompt:'请选择取货日期',editable:false"/>
                </td>
			</tr>
			<tr>
			<td class="tdR"><span style="color: red">*</span>金额（元）:</td>
				<td>
				   <input type="text"  id="money" precision="2" name="money" class="easyui-numberbox"  min="0" style="width: 150px;height: 24px;"  />
				</td>
				<td class="tdR">备注:</td>
				<td>
					<input id="remark" name="remark" class='easyui-textbox' data-options="multiline:true,validType:['length[0,100]']" style="width:375px;height:30px"/>
				</td>
			</tr>
			<tr>
